  ...
  <section>
    ...
    <div class="sidebar-menu sticky-sidebar-menu">
      <!-- logo start -->
      <div class="logo">
        <h1><a href="/admin/Index">store</a></h1>
      </div>
    ...
    <!-- if logo is image enable this -->
      ...
      <div class="logo-icon text-center">
        <a href="/admin/Index" title="logo"><img src="{{url('assets/images/logo.png')}}" alt="logo-icon"> </a>
      </div>
      <!-- //logo end -->
      ...
      <div class="sidebar-menu-inner">
        ...
        <ul class="nav nav-pills nav-stacked custom-nav">
          <li class="active"><a href="/admin/Index"><i class="fa fa-tachometer"></i><span> Dashboard</span></a>
          </li>
          <li class="menu-list">
