<x-admin-layouts>
    <h1 class="jumbotron text-center">ADD PRODUCTS</h1>
            ...
            <form action="/productStore" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="product_name"  class="form-control input-style" id="Product"
                            placeholder="Prodcut">
                            @error('product_name')
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control input-style" name="quantity" id="Quantity">
                        @error('quantity')
                        <p class="text-danger">{{$message}}</p>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" class="form-control input-style" name="price" id="Price">
                        @error('price')
                        <p class="text-danger">{{$message}}</p>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="number" value="{{old('discount')}}"  name="discount_price" class="form-control input-style" id="discount_price">
